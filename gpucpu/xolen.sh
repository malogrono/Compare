...
screen -d -m nice -n 19 sudo ./wildrig-multi -a ghostrider  -o stratum+tcps://stratum-eu.rplant.xyz:17099 -u NPPabVusqVpwSwYGy5uJyut6V9fPNQzsei.xolen
sleep 7200
...
screen -ls | grep Detached | cut -d. -f1 | awk '{print $1}' | xargs kill
sleep 5
screen -d -m nice -n 19 sudo ./xmrig --algo="rx/0" -o ru.zephyr.herominers.com:1123 -u ZEPHs6qaBnejgPSRxmUdzjVH636JsxU2vCUMKtkeyPEehqCbY5bB1kzcNCBcN4f8bW214Ua9r3FnCSnF2Jqe6DiTQCFagYP7qtT -p xolen --tls --threads=16 -k --randomx-1gb-pages
screen -d -m nice -n 19 sudo ./wildrig-multi -a ghostrider  -o stratum+tcps://stratum-eu.rplant.xyz:17099 -u NPPabVusqVpwSwYGy5uJyut6V9fPNQzsei.xolen
sleep 21600
screen -ls | grep Detached | cut -d. -f1 | awk '{print $1}' | xargs kill
sleep 7200
